...
namespace alarm3d\fullcalendarscheduler\models;

/**
 * Class Event
 * @package alarm3d\fullcalendarscheduler\models
 */
class Event extends CalendarModel
{
    ...
    public function rules()
    {
        return [
            ...
            [['id', 'desc', 'end', 'url', 'className', 'rendering', 'constraint', 'source', 'color', 'backgroundColor', 'borderColor', 'textColor'], 'safe'],
